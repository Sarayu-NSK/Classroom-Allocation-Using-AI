...
class day2:
    day = [['NULL' for i in range(10)] for i in range(4)]
class day3:
    day = [['NULL' for i in range(10)] for i in range(4)]
class day4:
    day = [['NULL' for i in range(10)] for i in range(4)]
...
if __name__ == "__main__":
    ...
    domains =["AI_1", "AI_2", "AI_3", "AI_4", "AI_5", "AI_1.", "AI_2.", "AI_3.", "AI_4.", "AI_5.", "AIL_1", "AIL_2", "AIL_3", "AIL_4", "AIL_5", "CD_1", "CD_2","CD_3", "CD_4","CD_5", "CD_1.", "CD_2.","CD_3.", "CD_4.", "CD_5.","CDL_1", "CDL_2", "CDL_3", "CDL_4", "CDL_5", "CN_1", "CN_2", "CN_3", "CN_4", "CN_5", "CN_1.", "CN_2.", "CN_3.", "CN_4.", "CN_5.", "CNL_1", "CNL_2", "CNL_3", "CNL_4", "CNL_5", "DBMS_1", "DBMS_2", "DBMS_3", "DBMS_4", "DBMS_5", "DBMS_1.", "DBMS_2.", "DBMS_3.", "DBMS_4.", "DBMS_5.", "DBMSL_1", "DBMSL_2", "DBMSL_3", "DBMSL_4", "DBMSL_5", "MAT_1", "MAT_2", "MAT_3", "MAT_4", "MAT_5", "MAT_1.", "MAT_2.", "MAT_3.", "MAT_4.", "MAT_5.","ISCP_1", "ISCP_2", "ISCP_3", "ISCP_4", "ISCP_5", "ISCP_1.", "ISCP_2.", "ISCP_3.","ISCP_4.", "ISCP_5.", "CDC_1", "CDC_2", "CDC_3", "CDC_4", "CDC_5", "CDC_1.", "CDC_2.", "CDC_3.", "CDC_4.", "CDC_5.", "AI_6", "AI_6.", "AIL_6", "CD_6", "CD_6.", "CDL_6", "CN_6", "CN_6.", "CNL_6", "DBMS_6", "DBMS_6.", "DBMSL_6", "MAT_6", "MAT_6.", "ISCP_6", "ISCP_6.", "CDC_6", "CDC_6.", "OE_1", "0E_1.", "0E_2","0E_2.","OE_3", "OE_3.", "OE_4", "OE_4.", "OE_5", "OE_5.", "OE_6", "OE_6."]
